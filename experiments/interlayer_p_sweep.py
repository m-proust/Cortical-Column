"""Sweep inter-layer coupling: scale every inter-layer conductance by p (probabilities
unchanged), one unstimulated SIM_MS run per p in P_VALUES.
"""
...
TRANSIENT_MS   = 500
NETWORK_SEED   = 58910
SAVE_DIR       = "saved_trials/interlayer_p_sweep"
...
CONFIG_FILES = [
    ...
    "experiments/interlayer_p_sweep.py",
]
