...
csv_layer_configs, _INTER_LAYER_CONNECTIONS, _INTER_LAYER_CONDUCTANCES = load_connectivity_from_csv(
    'config/primate_data/connection_probabilities.csv',
    'config/primate_data/conductances_AMPA_GABA.csv',
    'config/primate_data/conductances_NMDA.csv'  )
...
_LAYER_CONFIGS = {
    'L23': {
        ...
        'poisson_inputs': {
            ...
            'SOM':      {'target': 'gE_AMPA', 'weight': 'EXT_AMPA', 'N': 16},
...
CONFIG = {
    ...
    'intrinsic_params': {
        'E':   {'a': 4*nS, 'b': 130*pA, 'DeltaT': 2*mV,
                'C': 97*pF, 'gL': 4.2*nS, 'tauw': 500*ms, 'EL': -65*mV},
