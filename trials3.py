"""
trials3.py — Fixed-network trials with corrected L6 drive.

Same as trials2.py but with realistic L6 thalamic input:
  - L6 drive ~15% of L4C (was ~42%)
  - L6 PV gets 2.5x weight, E gets 1x (was swapped)
  - N=6, rate=3 Hz for both L6 populations
"""
