"""Mitzdorf 1D laminar CSD realigned on the alpha trough of a reference channel.

Run:
    path/to/your/venv/bin/python analysis/laminar/alpha_csd_layers.py
"""
import os
import glob
import numpy as np
...
def main():
    save_dir = os.path.join(TRIAL_DIR, 'csd_alpha')
